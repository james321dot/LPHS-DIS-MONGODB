    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Sorry This Page is Under Maintenance By: James Guiriba.
        </p>
        <div className="mt-6">
          <Link
            to="/"
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Sorry This Page is Under Maintenance, We Bring it Back onece were Done
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Libon Private High School" },
      ...
      { name: "apple-mobile-web-app-title", content: "LPHS Attend" },
      { name: "twitter:title", content: "LPHS Digital Attendance System" },
      {
